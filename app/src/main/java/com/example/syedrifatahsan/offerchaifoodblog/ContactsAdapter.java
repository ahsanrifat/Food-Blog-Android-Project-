...
public class ContactsAdapter extends
    ...
    public ContactsAdapter(List<ModelViewAdd> contacts,Context context) {
    ...
    public ContactsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View contactView = inflater.inflate(R.layout.add_view_layout, parent, false);
...
//                    .into(imageViewAddImage); //Your imageView variable
            ...
            Button bookmark = viewHolder.bookmark;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            bookmark=itemView.findViewById(R.id.bookmarkID);
        }
    }

    public void bookMarkThis(String addKey){

        DatabaseReference databaseReference=FirebaseDatabase.getInstance().getReference().child("Bookmark");
        String key=databaseReference.push().getKey();
        databaseReference.child(key).setValue(new BookmarkAdd(key,addKey,LoginAsFoodLover.userKey));
        Toast.makeText(context, "Added to Bookmark", Toast.LENGTH_SHORT).show();
//        Intent intent=new Intent(context,Blog_Home.class);
//        context.startActivity(intent);
